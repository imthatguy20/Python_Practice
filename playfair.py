...
def get_message():
	...
	new_message = []
	for char in m.upper():
		if char in alpha: # handle valid characters in the  new message
			new_message.append(char)
		elif char == "J": # handle the case when "J" appears in the new message
			new_message.append("I")
		elif char == ".": # swap out the period with an x
...
Brief: Performs encryption of the given message with the keyed Playfair
	matrix.
...
Brief: Performs decryption of the given message with the keyed Playfair
	matrix.
